...
public class SimpleLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VAR", "FALSE", "TRUE", "WRITE", "IF", "THEN", "ELSE", "STRING", "OPLOG", 
			"OPNEG", "OPREL", "OPAD", "OPMULT", "ATRIB", "PVIG", "PONTO", "DPONTOS", 
			"VIG", "ABPAR", "FPAR", "CADEIA", "CTE", "ID", "COMENTARIO", "WS"
		};
	}
